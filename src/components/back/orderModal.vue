    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row border-bottom mb-3">
            <div class="col-6">
              ...
              <div class="mb-3">
                <p class="mb-1">訂購人</p>
                <input type="text" class="form-control" v-model="tempOrderData.user.name" :readonly="!editMode" :disabled="!editMode">
              </div>
              <div class="mb-3">
                <p class="mb-1">訂購信箱</p>
                <input type="text" class="form-control" v-model="tempOrderData.user.email" :readonly="!editMode" :disabled="!editMode">
              </div>
              <div class="mb-3">
                <p class="mb-1">訂購電話</p>
                <input type="text" class="form-control" v-model="tempOrderData.user.tel" :readonly="!editMode" :disabled="!editMode">
              </div>
              <div class="mb-3">
                <p class="mb-1">訂購地址</p>
                <input type="text" class="form-control" v-model="tempOrderData.user.address" :readonly="!editMode" :disabled="!editMode">
              </div>
              <div class="mb-3">
                <p class="mb-1">訂購人訊息</p>
                <input type="text" class="form-control" v-model="tempOrderData.message" readonl disabled>
              </div>
            </div>
            <div class="col-6">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" @click="editOrder(tempOrderData.id)">{{ editMode ? '保存' : '編輯' }}</button>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    editOrder (id) {
      if (!this.editMode) {
        ...
        axios.put(`${VITE_API}/api/${VITE_PATH}/admin/order/${id}`, { data: this.tempOrderData })
          .then(res => {
